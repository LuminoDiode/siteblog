namespace backend.Models.Runtime
{
	...
	public class FileUrnServiceSettings
	{
		...
		public virtual string staticFilesUrnPath { get; set; } = @"staticfiles"; 
		public virtual string imagesDirectoryPath { get; set; } = @"user_added/images";
		public virtual string imageFileExtension { get; set; } = @"jpeg";
	}
}
